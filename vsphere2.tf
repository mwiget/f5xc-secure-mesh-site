...
module "vsphere2" {
  ...
  #inside_network       = "vsphere2_inside"

  # marcel colo
  nodes = [
    { name = "master-0", host = "192.168.40.100", datastore = "datastore2", ipaddress = "192.168.40.115/24" },
    { name = "master-1", host = "192.168.40.100", datastore = "datastore2", ipaddress = "192.168.40.116/24" },
    { name = "master-2", host = "192.168.40.100", datastore = "datastore2", ipaddress = "192.168.40.117/24" }
  ]
